...
SECRET_KEY = 'django-insecure-!p^bj8(q*knew8)h*0j-ld=bc03=7=a*nc28&6@$9o*-h7o)&)'
...
STATIC_URL = 'static/'
# The directory to store static files (relative to the project directory)
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Custom static directory
]

# The directory where static files will be collected in production
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # For production use (run `collectstatic`)
